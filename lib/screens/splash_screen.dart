            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: const Color(0xFFE50914).withOpacity(0.4), blurRadius: 30, spreadRadius: 2)],
                ),
              ...
              Text('Rạp Phim Fshare', style: TextStyle(fontSize: 14, color: Colors.white.withOpacity(0.5))),
              const SizedBox(height: 40),
              const SizedBox(width: 24, height: 24, child: CircularProgressIndicator(strokeWidth: 2.5, color: Color(0xFFE50914))),
              const SizedBox(height: 16),
              Text(_status, style: TextStyle(fontSize: 13, color: Colors.white.withOpacity(0.4))),
            ],
          ),
        ),
      ),
